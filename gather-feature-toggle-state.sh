...
docker cp "$discovery_id".discovery:/edx/app/discovery/discovery/discovery_waffle.json feature-toggle-data
...
docker cp "$ecommerce_id".ecommerce:/edx/app/ecommerce/ecommerce/ecommerce_waffle.json feature-toggle-data
