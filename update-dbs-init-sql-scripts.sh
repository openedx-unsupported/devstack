...
# Load the demo course during provisioning so that the DB dump will
# have it. This relies on the Mongo dump being included as well.
export DEVSTACK_LOAD_DEMO_COURSE=yes
